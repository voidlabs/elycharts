...
$.elycharts.line = {
  ...
  draw : function(env) {
    ...
    for (serie in values) {
      ...
      // TODO Check whether settiong props this way may "break" partial updates (using "lineCenter: auto" and updating from one with indexCenter = bar to indexCenter = line)
